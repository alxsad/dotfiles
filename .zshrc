...
plugins=(git osx iterm2 composer node npm yarn vagrant symfony2 brew docker encode64 urltools ruby gem gradle history sudo zsh-autosuggestions zsh-syntax-highlighting catimg colored-man-pages golang jsontools nmap postgres react-native zsh_reload)
